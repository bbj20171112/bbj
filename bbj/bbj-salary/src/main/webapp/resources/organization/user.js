...
var tableName = "org_user"; // 当前表名称
var dictionary = {}; // 数据字典
var baseURL = contextPath + "/organization/user"; // 基URL
var tableDataTable = {}; // 表格对象
var tableElementId = "table-org_user"; // 当前表名称
var modalElementId = "modal-org_user"; // 当前表名称
