package com.bbj.salary.controller;
...
import com.bbj.salary.Constants;
import com.bbj.salary.domain.Salary;
import com.bbj.salary.service.SalaryService;

@Controller
@RequestMapping(value={Constants.module_current + "/salary"})
public class SalaryController {
	...
	public Object insert(HttpServletRequest request){
		Salary salary = BBJEntityUtils.parseFrom(request, Salary.class);
		BBJServiceParam serviceParam = new BBJServiceParam()
		.addAttr(BBJServiceParam.keyEntity, salary);
		return salaryService.insert(serviceParam);
	}
	...
	*/
	...
	public Object delete(@PathVariable("id")String id,HttpServletRequest request){
		...
		return salaryService.delete(serviceParam);
	}
	...
	public Object update(HttpServletRequest request){
		...
		BBJServiceParam serviceParam = new BBJServiceParam()
		.addAttr(BBJServiceParam.keyEntity, salary);
		return salaryService.update(serviceParam);
	}
	...
	public Object query(@PathVariable("id")String id,HttpServletRequest request){
		BBJServiceParam serviceParam = new BBJServiceParam()
		.addAttr(BBJServiceParam.keyId, id);
		return salaryService.query(serviceParam);
	}
	...
	public Object queryByPage(@RequestParam(value="start",defaultValue="1")int start,
		...
		map.put("data", salaryService.queryByPage(serviceParam));
		map.put("recordsTotal", salaryService.getTotalRow(serviceParam));
		map.put("recordsFiltered", salaryService.getTotalRow(serviceParam));
		map.put("draw", draw);
	...
	public Object page(HttpServletRequest request){
		return Constants.module_current + "/salary";
	}
