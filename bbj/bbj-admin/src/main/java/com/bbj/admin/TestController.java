...
public class TestController {
	...
	*/
	...
	public Object queryByPage(@RequestParam(value="start",defaultValue="1")int start,
		...
		map.put("data", testService.queryByPage(tagPage, length, sqlFilter));
		map.put("recordsTotal", testService.getTotalRow(sqlFilter));
		map.put("recordsFiltered", testService.getTotalRow(sqlFilter));
		map.put("draw", draw);
