...
var tableId = "1524497478126"; // 当前表ID
var dictionary = {}; // 数据字典
var baseURL = contextPath + "/admin/menu/menu"; // 基URL
var tableDataTable = {}; // 表格对象
var tableElementId = "table-admin_menu"; // 当前表ID
var modalElementId = "modal-admin_menu"; // 当前表ID
