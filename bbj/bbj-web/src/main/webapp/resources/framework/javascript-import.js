...
document
		.writeln('<script src="'
				+ contextPath
				+ '/resources/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>');
...
document.writeln('<script src="' + contextPath
		+ '/resources/bower_components/PACE/pace.min.js"></script>');

document.writeln('<!-- SlimScroll -->');
document
		.writeln('<script src="'
				+ contextPath
				+ '/resources/bower_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>');
...
document.writeln('<script src="' + contextPath
		+ '/resources/framework/widgets/js/grid.js"></script>');
...
document.writeln('<script src="' + contextPath
		+ '/resources/plugins/layer/layer.min.js"></script>');
