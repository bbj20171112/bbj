...
document.writeln('<link rel="stylesheet" href="' + contextPath + '/resources/framework/widgets/css/alert.css">');

document.writeln('<!-- grid -->');
document.writeln('<link rel="stylesheet" href="' + contextPath + '/resources/framework/widgets/css/grid.css">');
