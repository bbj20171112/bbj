...
function getRealPath() {
    ...
    if(basePath.length < 15){ // 临时处理，让支持在纯静态页面下能直接打开
    	basePath = "../../../..";
    }
    return basePath;
}
...
document.writeln('<link rel="stylesheet" href="' + contextPath + '/resources/base/widgets/css/alert.css">');

document.writeln('<!-- grid -->');
document.writeln('<link rel="stylesheet" href="' + contextPath + '/resources/base/widgets/css/grid.css">');

document.writeln('<!-- jquery.dataTables.css -->');
document.writeln('<link rel="stylesheet" href="' + contextPath + '/resources/bower_components/datatables.net/css/jquery.dataTables.css">');

document.writeln('<!-- dataTables -->');
document.writeln('<link rel="stylesheet" href="' + contextPath + '/resources/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">');

document.writeln('<!-- ionicons -->');
document.writeln('<link rel="stylesheet" href="' + contextPath + '/resources/bower_components/Ionicons/css/ionicons.min.css">');

document.writeln('<!-- Awesome Bootstrap Checkbox -->');
document.writeln('<link rel="stylesheet" href="' + contextPath + '/resources/plugins/AwesomeBootstrapCheckbox/awesome-bootstrap-checkbox.css">');
...
document.writeln('<link rel="stylesheet" href="' + contextPath + '/resources/base/common/css/base.css">');
