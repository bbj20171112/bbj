...
<%@ include file="../framework/css.jsp"%>
				...
				<ul class="nav navbar-nav" id="menu-navbar">
					<li class="dropdown" style="display: none" name="first-level-menu">
						...
						<ul class="dropdown-menu">
							<li name="second-level-menu" style="display: none"><a href="javascript:open();" name="second-level-menu-text">Dropdown</a></li>
						</ul>
					</li>
				</ul>
...
<%@ include file="../framework/javascript.jsp"%>
</html>